                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{./tei:idno[@type='GND']}" target="_blank">
                                            <xsl:value-of select="tokenize(./tei:idno[@type='GND'][1], '/')[last()]"/>
                                        </a>
                                    </td>
                                </tr>
                                </xsl:if>
                            ...
                            <tbody>
                                ...
                                <xsl:if test="./tei:idno[@type='WIKIDATA']/text()">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{./tei:idno[@type='WIKIDATA']}" target="_blank">
                                                <xsl:value-of select="tokenize(./tei:idno[@type='WIKIDATA'][1], '/')[last()]"/>
                                            </a>
                                        </td>
                                    </tr>
                                </xsl:if>
                                <xsl:if test="./tei:idno[@type='GEONAMES']/text()">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{./tei:idno[@type='GEONAMES']}" target="_blank">
                                                <xsl:value-of select="tokenize(./tei:idno[@type='GEONAMES'][1], '/')[4]"/>
                                            </a>
                                        </td>
                                    </tr>
                                </xsl:if>
